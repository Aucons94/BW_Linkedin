	...
	return (
		<Container className="mt-4">
			<Row className="align-items-end flex-column">
				...
				<Col xs={3} className="bg-white rounded-3 border border-tertiary px-3">
					<div className="d-flex justify-content-between mt-3">
						<div>
							<span className="fw-bold">Lingua del profilo</span>
							<p className="fw-light mt-1 mb-0">Italiano</p>
						</div>
						<FontAwesomeIcon icon={faPencil} style={{ color: "#404040" }} />
					</div>
					<hr className="my-3" />
				...
				<Col xs={3} className="bg-white rounded-3 border border-tertiary mt-3 px-0">
					...
					<div className="d-flex px-4">
						...
						<div>
							...
							<div>
								<Button variant="secondary" className="bg-white text-secondary mt-2">
					...
					<div>
						<a href="/" className="text-secondary border-top text-decoration-none d-flex justify-content-center py-2">
							Mostra tutto
						</a>
					</div>
				</Col>
				<Col xs={3} className="bg-white rounded-3 border border-tertiary mt-3 px-4">
					<div className="my-3">
				...
				<Col xs={3} className="bg-white rounded-3 border border-tertiary mt-3 px-0">
					...
					<p className="px-3">Aggiungi nuove competenze con questi corsi, gratuiti per 24 ore</p>
					<div className="d-flex px-3">
						...
						<div>
							<p className="fw-bold mb-0">Formazione essenziale su Javascript</p>
							<span>
								<small className="fw-light">1.397 visualizzazioni</small>
							</span>
						</div>
					</div>
					<div>
