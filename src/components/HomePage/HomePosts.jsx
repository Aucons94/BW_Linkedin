...
import { closeModal, deletePostsData, editProfile, formatModalToDelete, getPostsData } from "../../redux/actions";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faComment, faEllipsis, faPaperPlane, faRetweet, faThumbsUp, faXmark } from "@fortawesome/free-solid-svg-icons";
...
const HomePosts = () => {
  ...
  const setModalToDelete = (id) => {
    ...
    dispatch(formatModalToDelete("Conferma elimina", "Vuoi eliminare il post?", id));
  };
            ...
            {index < 20 && (
              <Card key={post._id} className="my-2 p-3 gap-3">
                <div className="d-flex">
                  ...
                  <div className="ms-3">
                    <h5 className="m-0">
                      {post.user.name} {post.user.surname} {/* {post._id} */}
                    </h5>
                  ...
                  <div className="ms-auto text-secondary">
                    ...
                    <Button variant="link" onClick={() => setModalToDelete(post._id)}>
