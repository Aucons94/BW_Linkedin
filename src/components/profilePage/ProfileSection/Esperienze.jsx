    ...
    <Card className="position-relative mt-4">
      <Container className="p-4 border-bottom">
        <div className="d-flex justify-content-between">
          ...
          <div>
            <ButtonLink>
              <FontAwesomeIcon className="fs-5 text-secondary" icon={faPlus} />
            </ButtonLink>
            <ButtonLink>
              <FontAwesomeIcon className="text-secondary ms-3" icon={faPencil} />
            </ButtonLink>
          </div>
        </div>
        ...
        <Row className="d-flex">
          ...
          <Col xs={11}>
            ...
            <p className="text-secondary"> A tempo pieno - 10 anni</p>
          </Col>
          <Col xs={1}></Col>
          <Col xs={11} className="p-0">
            <ul>
              <li>Sviluppato sito React</li>
        ...
        <Row className="d-flex">
          ...
          <Col xs={11} className="p-0">
            <ul>
              <li>Creato le miglia</li>
              <li>Abolizione delle armi</li>
            </ul>
          </Col>
        </Row>
      </Container>
